...
class Ui_Dialog(QMainWindow):
    def setupUi(self, Dialog):
        Dialog.setObjectName("KFUAstroAnalyzerESP")
...
"font: 18pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("KFUAstroAnalyzerESP", "KFUAstroAnalyzerESP"))
        Dialog.setWindowIcon(QtGui.QIcon('planet.ico'))
    ...
    def browse_image(self):
        fname = QFileDialog.getOpenFileName(self, 'Открывайте карту', str(Path.home()),"Image files (*.jpg *.png)")
        # self.fname = fname
        return fname

    def browse_folder(self):
        dname = QFileDialog.getExistingDirectory(self, 'Открывайте папку с легендой', str(Path.home()))
        # self.fname = fname
        return dname
